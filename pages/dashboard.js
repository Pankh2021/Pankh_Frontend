...
const RenderDashboard = ()=>{
    return (
      ...
      {projects&&projects.map((project, index)=>(
        ...
        <a onClick={()=>window.open(project.url)}><div key={index} className="flex text-base font-sans font-medium">{project.name} </div></a>
      </span>
                    </>
                  )
              )}
      ...
      <p>Please verify your email by clicking on the link sent to your email(Check spam as well)</p>
      }
   ...
   return (
      ...
      <p><a href="/signup">Register</a> to view this page</p>}
