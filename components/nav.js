...
<nav class="bg-white shadow">
  ...
  <form >
    <div class="relative text-gray-600 focus-within:text-gray-400">
      ...
      <input type="search" name='q' class="py-4 ml-10 mr-20 w-full text-sm text-white bg-gray-200 rounded-md pl-10 focus:outline-none focus:text-gray-900" placeholder="Search by brand,category, application, etc...."  />
    </div>
  </form>
</div>
